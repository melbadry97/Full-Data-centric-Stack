...
#ifndef NFD_DAEMON_FACE_VMAC_LINK_SERVICE_HPP
#define NFD_DAEMON_FACE_VMAC_LINK_SERVICE_HPP
 ...
 */
class VMACLinkServiceCounters : public virtual LinkService::Counters
{
public:
 ...
 */
class VMACLinkService FINAL_UNLESS_WITH_TESTS : public LinkService
                                                 , protected virtual VMACLinkServiceCounters
{
public:
  ...
  explicit
  VMACLinkService(const Options& options = {});
...
PROTECTED_WITH_TESTS_ELSE_PRIVATE: // send path
   ...
   */
  void
  sendLpPacket(int type, uint16_t seq, lp::Packet&& pkt, const EndpointId& endpointId);
...
private: // send path
   ...
   *  \param type indicates type of packet, 0 for Interest, 1 for Data, 2 for NACK
   */
  void
  sendNetPacket(lp::Packet&& pkt, const EndpointId& endpointId, int type);
...
VMACLinkService::getCounters() const
{
  return *this;
}
